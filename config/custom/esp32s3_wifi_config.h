...
#define USE_M5_4ENCODER_MOTOR_DRIVER
...
// old #define MAG_BIAS { 5.71473e-05, 1.42431e-05, -4.69262e-05 }
#define MAG_BIAS {-3.52872e-05, -3.91225e-05, 5.49002e-05}
// #define IMU_TWEAK {}
// #define MAG_TWEAK {}
...
#define MOTOR_OPERATING_VOLTAGE 7.8          // motor's operating voltage (used to calculate max RPM)
#define MOTOR_POWER_MAX_VOLTAGE 8.4          // max voltage of the motor's power source (used to calculate max RPM)
#define MOTOR_POWER_MEASURED_VOLTAGE 8     // current voltage reading of the power connected to the motor (used for calibration)
#define COUNTS_PER_REV1 983                 // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 983                 // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 983                 // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 983                 // wheel4 encoder's no of ticks per rev
...
#ifdef USE_M5_4ENCODER_MOTOR_DRIVER  // motors on the board are numbered from 0
  #define MOTOR1_ADDR 36
  #define MOTOR1_NUMBER 1

  #define MOTOR2_ADDR 36
  #define MOTOR2_NUMBER 0

  #define MOTOR3_ADDR 36
  #define MOTOR3_NUMBER 2

  #define MOTOR4_ADDR 36
  #define MOTOR4_NUMBER 3
...
#define USE_SYSLOG
#define SYSLOG_SERVER { 192, 168, 1, 115 }  // eg IP of the desktop computer
...
#define SDA_PIN 13 // specify I2C pins
#define SCL_PIN 15
